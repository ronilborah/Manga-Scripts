        ...
        if [[ $use_current == "y" || $use_current == "Y" ]]; then
            ...
            while true; do
                ...
                if [ -z "$custom_dir" ]; then
                    ...
                    # Expand ~ to home directory and remove escape characters
...
run_downloader() {
    ...
    # echo "DEBUG: manga_id=$manga_id manga_slug=$manga_slug chapter_args=$chapter_args output_dir=$output_dir"
